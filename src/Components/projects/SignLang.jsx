                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="flex-1 space-y-4">
                                <div className="mb-6 p-6 bg-gradient-to-br from-purple-900/30 to-pink-900/30 rounded-xl border border-purple-500/20 backdrop-blur-sm">
                                    ...
                                    The project aims to create adaptive accessibility technology for the deaf and hard of hearing communities.
                                    </p>
                                </div>
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center gap-12">
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            <p className="text-lg leading-relaxed">
                                ...
                                model introduces dependencies to the previous observation, that help capture word state
                                transitions in a sequence, while eliminating emissions; each word is its own state and our 
                                ...
                                still limited as it cannot accurately capture long term sequences without it being 
